package com.heelenyc.research.misc.ssl;
...
public class SSLHandshakeServer {
    ...
    public void run() throws Exception {
        ...
        InputStream in = this.getClass().getResourceAsStream("sslserverkeys");
        ...
        serverSocket.bind(new InetSocketAddress(1443));
        serverChannel.register(selector, SelectionKey.OP_ACCEPT);

        logger.info("Server listens on port 1443... ...");
    ...
    private void handleRequest(SelectionKey key) throws Exception {
        ...
        if (key.isAcceptable()) {
            ...
            logger.info("Server finish accept... ...");
