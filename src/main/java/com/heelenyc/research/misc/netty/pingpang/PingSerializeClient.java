package com.heelenyc.research.misc.netty.pingpang;
...
public class PingSerializeClient {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length < 2 || args.length > 4) {
            System.err.println("Usage: " + PingSerializeClient.class.getSimpleName() + " <host> <port> [<number of messages>] [<size of array of bytes>]");
            return;
        }
