...
/**
 * Money MongoCollection 管理器，通过这个管理器来操作所有的Collection
 * 
 */
public class MongoCollectionFactory {
    ...
    /**
     * all the collection of the common
     */
    public static class common {
         ...
         */
        public static <T> MongoCollection<T> lock(Class<T> entityClass) {
            return getMongoCollection(REPLICA_SET, "common", "lock", entityClass);
        }
    }

    /**
     * all colletion of hubble
     * 
     * @author yicheng
     * @since 2013年11月28日
     * 
     */
    public static class hubble {
        private static final String REPLICA_SET = "localhost:28018";
         ...
         * @return
         */
        public static <T> MongoCollection<T> monitorUnit(Class<T> entityClass) {
            return getMongoCollection(REPLICA_SET, "hubble", "monitorUnit", entityClass);
        }
         ...
         * @return
         */
        public static <T> MongoCollection<T> monitorGroup(Class<T> entityClass) {
            return getMongoCollection(REPLICA_SET, "hubble", "monitorGroup", entityClass);
        }
         ...
         * @return
         */
        public static <T> MongoCollection<T> user(Class<T> entityClass) {
            return getMongoCollection(REPLICA_SET, "hubble", "user", entityClass);
        }
         ...
         * @return
         */
        public static <T> MongoCollection<T> userGroup(Class<T> entityClass) {
            return getMongoCollection(REPLICA_SET, "hubble", "userGroup", entityClass);
        }
         ...
         * @return
         */
        public static <T> MongoCollection<T> indicatorGroup(Class<T> entityClass) {
            return getMongoCollection(REPLICA_SET, "hubble", "indicatorGroup", entityClass);
        }
         ...
         * @return
         */
        public static <T> MongoCollection<T> alarmGroup(Class<T> entityClass) {
            return getMongoCollection(REPLICA_SET, "hubble", "alarmGroup", entityClass);
        }
         ...
         * @return
         */
        public static <T> MongoCollection<T> edenDataSetting(Class<T> entityClass) {
            return getMongoCollection(REPLICA_SET, "hubble", "edenDataSetting", entityClass);
        }
    }
